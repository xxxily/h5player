import{_ as s}from"./chunks/allowExternalCustomConfiguration.C5VXoknE.js";import{_ as i,c as a,o as n,a5 as l}from"./chunks/framework.fQL-neGn.js";const C=JSON.parse('{"title":"HTML5播放器自定义配置","description":"","frontmatter":{},"headers":[],"relativePath":"zh/home/customConfiguration.md","filePath":"zh/home/customConfiguration.md","lastUpdated":1712059366000}'),p={name:"zh/home/customConfiguration.md"},h=l('<h1 id="html5播放器自定义配置" tabindex="-1">HTML5播放器自定义配置 <a class="header-anchor" href="#html5播放器自定义配置" aria-label="Permalink to &quot;HTML5播放器自定义配置&quot;">​</a></h1><p>为了解决键位被大量占用，和快捷键冲突等问题，<code>v3.7.0</code> 版本增加了允许外部自定义快捷键和自定义配置等能力。</p><p>出于安全的考虑和尽可能减少潜在的外部污染，自定义外部能力需要菜单开启后才能使用：</p><img src="'+s+`" width="380" alt="allowExternalCustomConfiguration"><p>开启后即可通过外部脚本来定义该插件的快捷键和其它相关的能力</p><h2 id="功能定制说明" tabindex="-1">功能定制说明 <a class="header-anchor" href="#功能定制说明" aria-label="Permalink to &quot;功能定制说明&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>通过自定义配置，基本可以满足绝大部分的个性化需求，但同时要求你有一定的编程能力。<br> 如果是简单的自定义，例如自定义快捷键，不懂的可以入群，问群友即可。<br> 复杂的功能定制，不想折腾的，可以考虑找作者付费定制。</p></div><p>您可参照下面这份脚本来进行自定义：<a href="https://greasyfork.org/zh-CN/scripts/455396" target="_blank" rel="noreferrer">https://greasyfork.org/zh-CN/scripts/455396</a></p><h2 id="完整自定义参考代码" tabindex="-1">完整自定义参考代码 <a class="header-anchor" href="#完整自定义参考代码" aria-label="Permalink to &quot;完整自定义参考代码&quot;">​</a></h2><p>下面是完整的自定义参考代码：</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// ==UserScript==</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div>`,11),k=[h];function E(t,e,r,d,y,g){return n(),a("div",null,k)}const o=i(p,[["render",E]]);export{C as __pageData,o as default};
