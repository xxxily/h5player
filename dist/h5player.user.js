...
// @name:es      Script de mejora de audio y video: ajuste de velocidad sin límites, descargas, capturas y más.
...
// @description:es  Script potenciador para reproductores de video H5. Compatible con la mayoría de sitios como Bilibili, Douyin, Tencent Video, YouTube, Twitter, etc. Control total con atajos de teclado: ajusta la velocidad, haz capturas de pantalla, activa el modo PiP (Picture-in-Picture), expande el video a la página completa, ajusta el brillo, saturación, contraste y más. Mejora tu experiencia al ver videos en línea, permitiendo también saltar anuncios, acelerar tutoriales y descargar videos.
// @author       ankvps
...
var es = {
  website: '🏠Página del script',
  about: 'Acerca de',
  issues: 'Soporte',
  faq: 'Preguntas frecuentes',
  setting: 'Configuración',
  hotkeys: 'Atajos de teclado',
  keyboardControl: 'Control por teclado',
  mouseControl: 'Control con el mouse',
  hotkeysDocs: 'Documentación de atajos',
  enable: 'Activar',
  disable: 'Desactivar',
  toggleStates: 'Activar/Desactivar',
  disableHotkeysTemporarily: 'Desactivar atajos temporalmente',
  toggleHotkeysTemporarily: 'Activar/Desactivar atajos temporalmente',
  enableHotkeys: 'Activar atajos de teclado',
  disableHotkeys: 'Desactivar atajos de teclado',
  donate: '👍Donar',
  aboutDonate: '¿Cuánto ha recibido el autor?',
  aboutAuthor: 'Acerca del autor',
  enableScript: 'Activar script',
  disableScript: 'Desactivar script',
  disableCurrentInstanceGUI: 'Cerrar la interfaz gráfica de usuario actual',
  disableGUITemporarily: 'Desactivar la interfaz gráfica temporalmente',
  enableGUI: 'Activar interfaz gráfica de usuario',
  disableGUI: 'Desactivar interfaz gráfica de usuario',
  graphicalInterface: 'Interfaz gráfica',
  alwaysShowGraphicalInterface: 'Mostrar siempre la interfaz gráfica',
  openCrossOriginFramePage: 'Abrir páginas de dominio cruzado por separado',
  disableInitAutoPlay: 'Desactivar reproducción automática en este sitio',
  enableInitAutoPlay: 'Permitir reproducción automática en este sitio',
  restoreConfiguration: 'Restaurar configuración predeterminada global',
  blockSetPlaybackRate: 'Desactivar el control de velocidad predeterminado',
  blockSetCurrentTime: 'Desactivar el control de progreso predeterminado',
  blockSetVolume: 'Desactivar el control de volumen predeterminado',
  unblockSetPlaybackRate: 'Permitir el control de velocidad predeterminado',
  unblockSetCurrentTime: 'Permitir el control de progreso predeterminado',
  unblockSetVolume: 'Permitir el control de volumen predeterminado',
  allowAcousticGain: 'Activar amplificación de volumen',
  notAllowAcousticGain: 'Desactivar amplificación de volumen',
  allowCrossOriginControl: 'Activar control de dominio cruzado',
  notAllowCrossOriginControl: 'Desactivar control de dominio cruzado',
  allowExperimentFeatures: 'Activar funciones experimentales',
  notAllowExperimentFeatures: 'Desactivar funciones experimentales',
  experimentFeaturesWarning: 'Las funciones experimentales pueden causar problemas inesperados. Úselas con precaución.',
  useMediaDownloadTips: 'Para descargar, necesitas activar las funciones experimentales.\nEstas pueden causar problemas inesperados. ¿Estás seguro de que deseas activarlas?',
  allowExternalCustomConfiguration: 'Activar configuración externa personalizada',
  notAllowExternalCustomConfiguration: 'Desactivar configuración externa personalizada',
  changeLog: 'Registro de cambios',
  currentVersion: 'Versión actual',
  checkVersion: '¿Buscar nueva versión?',
  configFail: 'Error en la configuración',
  globalSetting: 'Configuración global',
  openCustomConfigurationEditor: 'Abrir editor de configuración personalizada',
  localSetting: 'Solo para este sitio web',
  openDebugMode: 'Activar modo de depuración',
  closeDebugMode: 'Desactivar modo de depuración',
  unfoldMenu: 'Expandir menú',
  foldMenu: 'Contraer menú',
  addGroupChat: '💬Unirse al chat grupal',
  speed: 'Velocidad',
  capture: 'Capturar',
  download: 'Descargar',
  mediaDownload: {
    enable: 'Activar descarga de medios',
    disable: 'Desactivar descarga de medios',
    downloadOptions: 'Opciones de descarga',
    downloading: 'El archivo se está descargando. ¿Seguro que quieres realizar esta operación de nuevo?',
    hasDownload: 'El archivo ya ha sido descargado. ¿Seguro que quieres realizar esta operación de nuevo?',
    confirmTitle: 'Por favor, introduce el nombre del archivo',
    notSupport: 'No se puede descargar este archivo. La función de descarga necesita mejoras.',
    notEndOfStream: 'Los datos del video no están completamente cargados, ¿seguro que quieres descargarlo ahora?',
    cancelAutoDownload: '¿Cancelar la descarga automática?',
    autoDownload: 'Los datos del video no están completos. ¿Quieres que la descarga comience automáticamente cuando esté listo?',
    notFoundMediaSource: 'No se encontraron los datos del video. Es posible que se hayan borrado o que el elemento ya no exista. Se recomienda refrescar la página e intentarlo de nuevo.'
  },
  menu: 'Menú',
  more: 'Más',
  moreActions: 'Más acciones',
  videoFilter: 'Filtro de video',
  resetFilterAndTransform: 'Restablecer filtros y transformaciones',
  brightnessUp: 'Aumentar brillo',
  brightnessDown: 'Disminuir brillo',
  contrastUp: 'Aumentar contraste',
  contrastDown: 'Disminuir contraste',
  saturationUp: 'Aumentar saturación',
  saturationDown: 'Disminuir saturación',
  hueUp: 'Aumentar matiz',
  hueDown: 'Disminuir matiz',
  blurUp: 'Aumentar desenfoque',
  blurDown: 'Disminuir desenfoque',
  rotateAndMirror: 'Rotar y reflejar',
  rotate90: 'Rotar 90 grados',
  horizontalMirror: 'Reflejo horizontal',
  verticalMirror: 'Reflejo vertical',
  videoTransform: 'Desplazamiento de video',
  translateRight: 'Mover imagen a la derecha',
  translateLeft: 'Mover imagen a la izquierda',
  translateUp: 'Mover imagen hacia arriba',
  translateDown: 'Mover imagen hacia abajo',
  languageSettings: 'Configuración de idioma',
  default: 'Predeterminado',
  autoChoose: 'Selección automática',
  comingSoon: 'Más funciones en desarrollo, ¡espéralas pronto!',
  ffmpegScript: 'Script para unir/convertir audio y video',
  autoGotoBufferedTime: 'Saltar automáticamente a la parte cargada',
  disableAutoGotoBufferedTime: 'Desactivar salto automático a la parte cargada',
  mouse: {
    enable: 'Activar control con el mouse',
    disable: 'Desactivar control con el mouse',
    longPressTime: 'Tiempo de respuesta para clic largo del mouse'
  },
  tipsMsg: {
    playspeed: 'Velocidad: ',
    forward: 'Adelantar: ',
    ...
    stopframe: 'Congelar fotograma: ',
    play: 'Reproducir',
    pause: 'Pausar',
    arpl: 'Reanudar reproducción automáticamente',
    drpl: 'No reanudar reproducción automáticamente',
    brightness: 'Brillo: ',
    contrast: 'Contraste: ',
    saturation: 'Saturación: ',
    hue: 'Matiz: ',
    blur: 'Desenfoque: ',
    imgattrreset: 'Atributos: restablecer',
    imgrotate: 'Rotación: ',
    onplugin: 'Plugin h5Player: ACTIVADO',
    offplugin: 'Plugin h5Player: DESACTIVADO',
    globalmode: 'Modo global: ',
    playbackrestored: 'Se ha restaurado el progreso de la última reproducción',
    playbackrestoreoff: 'La función de restaurar progreso está desactivada. Presiona SHIFT+R para activarla.',
    horizontal: 'Desplazamiento horizontal: ',
    vertical: 'Desplazamiento vertical: ',
    horizontalMirror: 'Reflejo horizontal',
    verticalMirror: 'Reflejo vertical',
    videozoom: 'Zoom del video: '
  }
};
